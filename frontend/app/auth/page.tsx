...
export default function AuthPage() {
            ...
            >
              {activeTab === tab && (
                <motion.div
                  ...
                  style={{
                    background: "linear-gradient(135deg, #1F4959, #2d7a96)",
                    boxShadow: "0 4px 14px rgba(31,73,89,0.4)",
                  }}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {activeTab === "signup" && (
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  style={{
                    backgroundColor: "rgba(31,73,89,0.3)",
            ...
            {activeTab === "signin" && (
              <div className="flex justify-end">
                <button
                  ...
                  style={{ color: "rgba(92,180,200,0.7)" }}
            ...
            <motion.button
              ...
              style={{
                background: isLoading ? "rgba(31,73,89,0.5)" : "linear-gradient(135deg, #1F4959 0%, #2d7a96 100%)",
                border: "1px solid rgba(92,124,137,0.35)",
                boxShadow: "0 8px 28px rgba(11,46,58,0.5), inset 0 1px 0 rgba(255,255,255,0.1)",
                fontFamily: "'DM Sans', sans-serif",
  ...
  return (
    ...
    >
      {/* ── Fixed background — stays throughout scroll on mobile ── */}
      <div
      ...
      <div
        ...
        style={{
          background: "linear-gradient(to bottom, rgba(7,17,26,0.7) 0%, rgba(7,17,26,0.55) 50%, rgba(7,17,26,0.82) 100%)",
        }}
      />

      {/* ── Animated code lines — fixed ── */}
      <div className="fixed inset-0 z-[15] pointer-events-none overflow-hidden">
        {floatingLines.map((line, i) => (
          <motion.div
            ...
            animate={{
              x: [0, i % 2 === 0 ? 10 : -10, 0, i % 2 === 0 ? -6 : 6, 0],
              opacity: [0.45, 0.85, 0.55, 0.8, 0.45],
              width: [line.width, line.width + 18, line.width - 10, line.width + 12, line.width],
              boxShadow: [
                `0 0 6px ${line.color}55`,
                `0 0 16px ${line.color}cc`,
                `0 0 8px ${line.color}77`,
                `0 0 13px ${line.color}aa`,
                `0 0 6px ${line.color}55`,
              ],
            }}
            transition={{
      ...
      <motion.nav
        ...
        style={{
          ...
          borderBottom: "1px solid rgba(92,124,137,0.1)",
        }}
      >
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => router.push("/")}>
          ...
          <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.3rem", fontWeight: 600, fontStyle: "italic", letterSpacing: "0.04em", background: "linear-gradient(90deg, #ffffff 0%, #a8cfd8 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
            KaryaLaya
          </span>
        </div>
        ...
        <motion.button
          ...
          style={{
            backgroundColor: "rgba(11,46,58,0.5)",
            border: "1px solid rgba(92,124,137,0.35)",
        ...
        <div className="w-full max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          ...
          >
            <div>
              ...
              >
                Your team's{" "}
                <span style={{ color: "#5CAFC4", fontStyle: "italic" }}>command</span>{" "}
                center.
              </h1>
      ...
      <div className="lg:hidden relative z-20 flex flex-col">
        ...
        {/* SECTION 1 — Hero / Branding (full screen height) */}
        <div
        ...
        >
          ...
          >
            {/* Eyebrow */}
            <div
              className="px-4 py-2 rounded-full text-xs font-semibold tracking-[0.22em] uppercase"
              style={{
